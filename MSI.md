...
- aktywne
  - time delay
    ...
    - e.g. LiDAR
  - triangulation
    - structured light pattern (Kinect, porównujemy wyświetlany wzorzec ze wzorcem referencyjnym, wymaga kalibracji)
...
- kalibracja na podstawie _wzorca referencyjnego_ na płaszczyźnie w znajej odległości
